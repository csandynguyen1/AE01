...
public class BeamTest : MonoBehaviour
{
    ...
    void PerformRaycastAndAdjustBeam(Vector2 directionToPlayer)
    {
        ...
        {
            //line.enabled = true;
            AdjustBeam((hit.point - (Vector2)transform.position).magnitude);
    ...
    void getStartAngle()
    {
        ...
        currentAngle = Mathf.Atan2(directionToPlayer.y, directionToPlayer.x) * Mathf.Rad2Deg - 180;
    ...
    void AimTowardsPlayer()
    {
        ...
        {
            Vector2 directionToPlayer = (player.transform.position - transform.position).normalized;
            float targetAngle = Mathf.Atan2(directionToPlayer.y, directionToPlayer.x) * Mathf.Rad2Deg - 180; // Adjust based on beam orientation
